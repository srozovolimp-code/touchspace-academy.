...
"alpine-floor-advanced": {
  ...
  logo: "../../images/brand-logos/Alpine_Floor.png",
  summary: "Академия Alpine Floor помогает реселлеру разобраться в структуре ассортимента, продуктовых категориях, визуальных решениях, подборе и коммуникации с покупателем.",
  final: false,
  courses: [
