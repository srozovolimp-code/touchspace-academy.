...
"alpine-floor-advanced": {
  name: "Расширенная академия Alpine Floor",
  category: "Ассортимент, подбор и коммуникация",
  logo: "../../images/brand-logos/Alpine_Floor.png",
  summary: "Расширенная академия Alpine Floor помогает реселлеру разобраться в структуре ассортимента, продуктовых категориях, визуальных решениях, подборе и коммуникации с покупателем.",
  final: false,
  courses: [
    ["alpine-floor-brand", "Знакомство с брендом Alpine Floor", "Позиционирование, широкий ассортимент, аудитории и роль реселлера.", "Модуль 1", "4 раздела", "Начальный", "35 мин", "art-blue", "../../icons/5.png", "alpine-floor-advanced-block-01.html"],
    ["alpine-floor-assortment", "Как устроен ассортимент", "Категории, коллекции, декоры, форматы и способы сокращать выбор для покупателя.", "Модуль 2", "5 разделов", "Средний", "45 мин", "art-mint", "../../icons/7.png", "alpine-floor-advanced-block-02.html"],
    ["alpine-floor-categories", "Основные категории продуктов", "SPC, LVT, ламинат, инженерная доска и другие категории бренда.", "Модуль 3", "5 разделов", "Средний", "50 мин", "art-violet", "../../icons/8.png", "alpine-floor-advanced-block-03.html"],
    ["alpine-floor-visual", "Коллекции и визуальные решения", "Доступные линии, Grand Sequoia, древесные и каменные образы, елка, шеврон и старшие решения.", "Модуль 4", "6 разделов", "Средний", "60 мин", "art-blue", "../../icons/9.png", "alpine-floor-advanced-block-04.html"],
    ["alpine-floor-selection", "Как подбирать решение", "Помещение, роль пола, категория, ценовые уровни, сравнение и готовые сценарии подбора.", "Модуль 5", "6 разделов", "Практика", "55 мин", "art-mint", "../../icons/10.png", "alpine-floor-advanced-block-05.html"],
    ["alpine-floor-communication", "Коммуникация, ценность и доверие", "От свойства к пользе, цена, возражения, документы и безопасные обещания.", "Модуль 6", "6 разделов", "Практика", "55 мин", "art-violet", "../../icons/11.png", "alpine-floor-advanced-block-06.html"],
    ["alpine-floor-algorithm", "Итоговый алгоритм реселлера", "Финальная последовательность консультации: задача, сценарий, категория, варианты, ограничения и завершение.", "Модуль 7", "6 разделов", "Итоговый", "50 мин", "art-blue", "../../icons/12.png", "alpine-floor-advanced-block-07.html"]
  ]
},
    "alta-step": {
      name: "Alta Step",
    ...
    "coswick-advanced": {
      ...
      courses: [
        ...
        ["wood-species-block-03", "Породы древесины Coswick", "Дуб, ясень и американский орех: как объяснять клиенту природный рисунок, вариативность древесины и корректные ожидания от натурального пола.", "Модуль 03", "4 раздела", "Средний", "45 мин", "art-violet", "../../icons/8.png", "coswick-advanced-block-03.html"],
        ["formats-patterns-block-04", "Форматы и рисунки укладки Coswick", "Паркетная доска, английская и французская елка, модульный паркет и паркетри: как формат меняет масштаб и характер интерьера.", "Модуль 04", "4 раздела", "Продвинутый", "60 мин", "art-blue", "../../icons/9.png", "coswick-advanced-block-04.html"]
      ]
    },
    ensten: {
      name: "Ensten",
