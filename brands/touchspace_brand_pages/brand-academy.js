...
"alpine-floor-advanced": {
  name: "Alpine Floor",
  category: "Ассортимент, подбор и коммуникация",
  logo: "../../images/brand-logos/Alpine_Floor.png",
  summary: "Этот курс поможет вам разобраться в структуре ассортимента, продуктовых категориях, визуальных решениях, подборе и коммуникации с покупателем.",
  final: false,
  courses: [
    ["alpine-floor-brand", "Знакомство с брендом Alpine Floor", "Вы разберете позиционирование бренда, широту ассортимента, ключевые аудитории и роль продавца в консультации.", "Модуль 1", "4 раздела", "Начальный", "35 мин", "art-blue", "../../icons/5.png", "alpine-floor-advanced-block-01.html"],
    ["alpine-floor-assortment", "Как устроен ассортимент", "Вы научитесь видеть логику категорий, коллекций, декоров и форматов, чтобы быстрее сокращать выбор для покупателя.", "Модуль 2", "5 разделов", "Средний", "45 мин", "art-mint", "../../icons/7.png", "alpine-floor-advanced-block-02.html"],
    ["alpine-floor-categories", "Основные категории продуктов", "Вы сравните SPC, LVT, ламинат, инженерную доску и смежные категории через задачи помещения и ожидания клиента.", "Модуль 3", "5 разделов", "Средний", "50 мин", "art-violet", "../../icons/8.png", "alpine-floor-advanced-block-03.html"],
    ["alpine-floor-visual", "Коллекции и визуальные решения", "Вы разберете древесные и каменные образы, крупный формат, елку, шеврон и старшие решения как инструменты подбора.", "Модуль 4", "6 разделов", "Средний", "60 мин", "art-blue", "../../icons/9.png", "alpine-floor-advanced-block-04.html"],
    ["alpine-floor-selection", "Как подбирать решение", "Вы соберете понятный алгоритм подбора: от помещения и роли пола до ценовых уровней и готовых сценариев.", "Модуль 5", "6 разделов", "Практика", "55 мин", "art-mint", "../../icons/10.png", "alpine-floor-advanced-block-05.html"],
    ["alpine-floor-communication", "Коммуникация, ценность и доверие", "Вы потренируете язык консультации: как переводить свойства в пользу, объяснять цену и корректно работать с возражениями.", "Модуль 6", "6 разделов", "Практика", "55 мин", "art-violet", "../../icons/11.png", "alpine-floor-advanced-block-06.html"],
    ...
    "pergo-advanced": {
      ...
      logo: "../../images/brand-logos/Pergo.png",
      summary: "Этот курс поможет вам разобраться в истории Pergo, конструкции ламината, технологиях, ассортименте, визуальном подборе, монтаже и корректной коммуникации с покупателем.",
      final: false,
      courses: [
        ["pergo-brand-history", "Бренд и история продукта", "Вы разберете происхождение Pergo, развитие продукта и научитесь использовать историю бренда без рекламных мифов.", "Модуль 1", "4 раздела", "Начальный", "48 мин", "art-blue", "../../images/brand-logos/Pergo.png", "pergo-advanced-block-01.html"],
        ["pergo-construction", "Конструкция ламината Pergo", "Вы научитесь корректно объяснять материал, слои и язык продукта без смешения категорий.", "Модуль 2", "4 раздела", "Средний", "52 мин", "art-mint", "../../images/brand-logos/Pergo.png", "pergo-advanced-block-02.html"],
        ["pergo-technologies", "Технологии Pergo", "Вы разберете TitanX, AquaSafe, Uniclic, PerfectFold, Unizip и Sensation без абсолютных обещаний.", "Модуль 3", "4 раздела", "Средний", "56 мин", "art-violet", "../../images/brand-logos/Pergo.png", "pergo-advanced-block-03.html"],
        ["pergo-assortment", "Ассортимент и продуктовая навигация", "Вы научитесь читать ассортимент по категории, формату, классу, замку и региональному статусу.", "Модуль 4", "4 раздела", "Средний", "58 мин", "art-blue", "../../images/brand-logos/Pergo.png", "pergo-advanced-block-04.html"],
        ["pergo-decor", "Декоры, цвета и визуальный подбор", "Вы разберете язык декоров, визуальный профиль и сценарии проверки образца в интерьере.", "Модуль 5", "4 раздела", "Практика", "50 мин", "art-mint", "../../images/brand-logos/Pergo.png", "pergo-advanced-block-05.html"],
        ["pergo-sales", "Подбор и продажа", "Вы соберете технический бриф, научитесь сокращать выбор и отвечать на возражения без преувеличений.", "Модуль 6", "4 раздела", "Практика", "62 мин", "art-violet", "../../images/brand-logos/Pergo.png", "pergo-advanced-block-06.html"],
        ["pergo-installation", "Монтаж, эксплуатация и гарантия", "Вы сможете передавать ключевые ограничения монтажа и снижать риск претензий после продажи.", "Модуль 7", "4 раздела", "Итоговый", "64 мин", "art-blue", "../../images/brand-logos/Pergo.png", "pergo-advanced-block-07.html"],
        ["pergo-final", "Итоговый практикум Pergo Advanced", "Финальная сценарная проверка по всем темам курса открывается после прохождения разделов.", "Итог", "8 вопросов", "Итоговый", "25 мин", "art-blue", "../../images/brand-logos/Pergo.png", "pergo-advanced-final-test.html"]
      ]
    },
    "alta-step": {
      name: "Alta Step",
    ...
    "coswick-advanced": {
      ...
      logo: "../../images/brand-logos/Coswick.png",
      summary: "Этот курс поможет вам последовательно разобраться в бренде Coswick, структуре ассортимента, коллекциях, форматах и правилах точной консультации.",
      final: false,
      courses: [
        ["brand-block-01", "Бренд Coswick", "Вы познакомитесь с фабрикой, историей развития, продуктовой системой и правилами корректной коммуникации бренда.", "Модуль 01", "4 раздела", "Начальный", "40 мин", "art-blue", "../../icons/5.png", "coswick-advanced-block-01.html"],
        ["assortment-block-02", "Как ориентироваться в ассортименте Coswick", "Вы разберете коллекции, оттенки, форматы и параметры выбора, чтобы вести клиента от общего запроса к конкретному продукту.", "Модуль 02", "4 раздела", "Средний", "55 мин", "art-mint", "../../icons/7.png", "coswick-advanced-block-02.html"],
        ["wood-species-block-03", "Породы древесины Coswick", "Вы научитесь объяснять дуб, ясень и американский орех через природный рисунок, вариативность и реалистичные ожидания от натурального пола.", "Модуль 03", "4 раздела", "Средний", "45 мин", "art-violet", "../../icons/8.png", "coswick-advanced-block-03.html"],
        ["formats-patterns-block-04", "Форматы и рисунки укладки Coswick", "Вы увидите, как паркетная доска, английская и французская елка, модульный паркет и паркетри меняют масштаб и характер интерьера.", "Модуль 04", "4 раздела", "Продвинутый", "60 мин", "art-blue", "../../icons/9.png", "coswick-advanced-block-04.html"]
      ]
    },
    ensten: {
      name: "Ensten",
  ...
  root.innerHTML = '<div class="topline">' +
    ...
    '<div class="section-head"><div><h2>Курсы бренда</h2><p>В каждом курсе указаны прогресс, уровень сложности и ориентировочное время прохождения.</p></div><span class="course-count">0 из ' + academy.courses.length + ' завершено</span></div>' +
